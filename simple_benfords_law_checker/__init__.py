...
app.config.from_mapping(
    ...
    USER_COL='user_col',    # TODO: remove, when plotter is refactored
...
def get_db():
    ...
    client = connect('test_mongodb', host=f'mongodb://{username}:{password}@{host}:{port}/{db_name}?authSource=admin')
